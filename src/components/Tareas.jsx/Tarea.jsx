            ...
            {expedientes.length === 0 ? (
                <div className="flex items-center justify-center min-h-screen -ml-60 mr-4 lg:-ml-0 lg:mr-0 xl:-ml-0 xl:mr-0">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500">No hay tareas por hacer en este momento</p>
                        <p className="text-gray-400 text-sm mb-4 text-center">Cuando se te asignen tareas seras notificado via correo electronico</p>
                    </div>
